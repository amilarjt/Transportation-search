...
if ($foundnum==0)
{
echo "Sorry, there are no matching result for <b>$search</b>.</br>Please check Job No you entered";
}
 else
{
...
?>
<form action='transportsearch.php' method='POST'>
